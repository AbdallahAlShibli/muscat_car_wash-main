    ...
    List<Widget> banners1 = [
      ...
      ClipRRect(
        ...
        child: CachedNetworkImage(
          ...
          fit: BoxFit.cover,
          imageUrl:
              'https://3.bp.blogspot.com/-eFUhozNDLts/W3aR1_8qGBI/AAAAAAAAAAM/Mvyywc2xtdEpzxPNsgEK3jBQExVus10QQCLcBGAs/s1600/Car%2Bwash.jpg',
          //   placeholder: (context, url) => CircularProgressIndicator(color: darkRedColor,),
          errorWidget: (context, url, error) => Icon(Icons.error),
        ),
      ),
      ClipRRect(
        ...
        child: CachedNetworkImage(
          ...
          fit: BoxFit.cover,
          imageUrl:
              'https://images.jdmagicbox.com/comp/bangalore/h5/080pxx80.xx80.160617221801.w4h5/catalogue/the-best-car-wash-kalkere-bangalore-car-washing-services-jwm1uukm78.jpg',
          //   placeholder: (context, url) => CircularProgressIndicator(color: darkRedColor,),
          errorWidget: (context, url, error) => Icon(Icons.error),
        ),
      ),
                                    ...
                                    PageRouteBuilder(
                                      pageBuilder: (c, a1, a2) =>
                                        ...
                                        serviceName: snapshot
                                            ...
                                            .toString(),
                                        servicePrice: snapshot
                                            .data!.docs[index]["servicePrice"]
                                            .toString(),
                                        serviceDescription: snapshot.data!
                                            .docs[index]["serviceDescription"]
                                            .toString(),
                                        payment: 'Not Paid',
                                        status: 'bookUser',
                                        docId: snapshot.data!.docs[index].id,
                                        serviceImage: snapshot
                                            .data!.docs[index]["serviceImage"]
                                            .toString(),
                                      ),
                                      transitionsBuilder:
                                          (c, anim, a2, child) =>
                                              ...
                                              children: [
                                                ...
                                                Center(
                                                  child: OutlinedButton(
                                                      onPressed: () => launch(
                                                          "tel:${snapshot.data!.docs[index]["shopPhone"].toString()}"),
                                                      child: new Text(
                                                        "Call Now",
                                                        style: TextStyle(
                                                            color: AppColors
