...
class AddNearestServiceScreen extends StatefulWidget {
  const AddNearestServiceScreen({super.key});

  @override
  State<AddNearestServiceScreen> createState() => _AddNearestServiceScreenState();
}

class _AddNearestServiceScreenState extends State<AddNearestServiceScreen> {
                          ...
                          children: [
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text('Upload Shop Image', style: TextStyle(color: AppColors.lightBlueColor2,fontWeight: FontWeight.bold),)),
                              ),
                            ),
                          ],),
                      ),
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                            ...
                            onPressed: () async {
                              if(_titleControoler.text.isEmpty)
                              {
                              ...
                              else if (_timeControoler.text.isEmpty  ) {
                                Utils.flushBarErrorMessage(
                                    "Enter Shop timing",
                                    context,
                                    AppColors.darkRedColor,
                                ...
                                try {
                                  FirebaseFirestore.instance
                                      ...
                                      .doc()
                                      .set({
                                    "shopName": _titleControoler.text,
                                    "shopDescription": _descriptionControoler.text,
                                    "shopPhone": _phoneControoler.text,
                                    "shopAddress": _addressControoler.text,
                                    "shopTime": _timeControoler.text,
